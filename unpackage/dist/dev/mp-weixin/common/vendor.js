...
function initRuntimeSocketService() {
  const hosts = "28.0.0.1,172.20.10.5,192.168.50.1,192.168.204.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_g1vqFY";
